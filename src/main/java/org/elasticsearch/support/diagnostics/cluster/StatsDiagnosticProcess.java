...
/**
 * {@code StatsDiagnosticProcess} performs a request to <code>{baseUrl}/_cluster/stats?pretty&amp;human</code> and
 * writes to <code>"cluster_stats.json"</code>.
 * <p />
...
class StatsDiagnosticProcess extends UnversionedHttpRequestDiagnosticProcess {
    ...
    StatsDiagnosticProcess(HttpRequestFactory httpRequestFactory) {
        super("_cluster/stats?pretty&human", "cluster_stats.json", httpRequestFactory);
    }
}

...
/**
 * {@code WaitHotThreadsDiagnosticProcess} performs a request to
 * <code>{baseUrl}/_nodes/hot_threads?threads=10&type=wait</code> and writes to
 * <code>"nodes_hot_threads_wait.txt"</code>.
 * <p />
 * As implied by the class extension, this does not currently have any version restrictions.
 */
@Singleton
class WaitHotThreadsDiagnosticProcess extends UnversionedHttpRequestDiagnosticProcess {
    /**
     * Create a new {@link WaitHotThreadsDiagnosticProcess}.
     */
    @Inject

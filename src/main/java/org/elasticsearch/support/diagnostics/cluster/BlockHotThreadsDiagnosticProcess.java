...
/**
 * {@code BlockHotThreadsDiagnosticProcess} performs a request to
 * <code>{baseUrl}/_nodes/hot_threads?threads=10&type=block</code> and writes to
 * <code>"nodes_hot_threads_block.txt"</code>.
 * <p />
 * As implied by the class extension, this does not currently have any version restrictions.
 */
@Singleton
class BlockHotThreadsDiagnosticProcess extends UnversionedHttpRequestDiagnosticProcess {
    /**
     * Create a new {@link BlockHotThreadsDiagnosticProcess}.
     */
    @Inject

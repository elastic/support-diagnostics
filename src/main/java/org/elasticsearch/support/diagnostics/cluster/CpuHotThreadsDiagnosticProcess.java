...
/**
 * {@code CpuHotThreadsDiagnosticProcess} performs a request to
 * <code>{baseUrl}/_nodes/hot_threads?threads=10&type=cpu</code> and writes to
 * <code>"nodes_hot_threads_cpu.txt"</code>.
 * <p />
 * As implied by the class extension, this does not currently have any version restrictions.
 */
@Singleton
class CpuHotThreadsDiagnosticProcess extends UnversionedHttpRequestDiagnosticProcess {
    /**
     * Create a new {@link CpuHotThreadsDiagnosticProcess}.
     */
    @Inject

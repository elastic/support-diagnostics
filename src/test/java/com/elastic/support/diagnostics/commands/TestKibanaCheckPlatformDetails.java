...
import com.elastic.support.diagnostics.commands.KibanaCheckPlatformDetails;
...
public class TestKibanaCheckPlatformDetails {
    ...
    public void testGetNodeNetworkAndLogInfo() {
        ...
        KibanaCheckPlatformDetails testClass = new KibanaCheckPlatformDetails();
    ...
    public void testFindTargetNode() {
        ...
        ProcessProfile testedNodeProfiles = testClass.findTargetNode("host", nodeProfiles);
    ...
    */
    ...
    public void testClusterFindTargetNode() {
        ...
        try {
            ...
            assertEquals(e.getMessage(), "Kibana can not run in cluster mode.");
        }
    }
}

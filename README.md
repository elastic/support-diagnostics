 ...
 - If you are reading this on Github you are almost there. Look at the right column of information near the top of the page and locate the block below **About** and above **Contributors** that says: **Releases** < some number > or just [click here](https://github.com/elastic/support-diagnostics/releases).
